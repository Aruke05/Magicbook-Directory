...
type HistoryItem = { id: string; templateId: string | null; templateName: string; matchedRuleName: string | null; source: "custom-rule" | "default-template"; inputData: Record<string, unknown>; content: string; createdAt: string }
